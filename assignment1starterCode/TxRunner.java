...
public class TxRunner {
    ...
    public static void main(String[] args) throws NoSuchProviderException, NoSuchAlgorithmException, InvalidKeyException, SignatureException {
        ...
        System.out.println("tx numInputs: " + tx.numInputs());
        System.out.println("tx numOutputs: " + tx.numOutputs());
        System.out.println("tx getInputs: " + tx.getInputs());
        System.out.println("utxoPool contains: " + utxoPool.contains(utxo));
        ...
        System.out.println("utxoPool.getAllUTXO().size() returns: " + utxoPool.getAllUTXO().size());
